...
public class SingleQuizBiologieActivity extends AppCompatActivity {
    ...
    //Score
    public static int Bilogiescore;
    ...
    public static boolean checkBiologyPoints;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_single_quiz_biologie);

        getSupportActionBar().setTitle("Biologie");
    ...
    private void loadServerQuestions() {
        ...
        JsonArrayRequest request = new JsonArrayRequest(
            ...
            public void onResponse(JSONArray response) {
                ...
                if (questionList.isEmpty()) {
                    Toast.makeText(SingleQuizBiologieActivity.this, "Empty Array", Toast.LENGTH_SHORT).show();
                } else {
                        ...
                        public void onClick(View v) {
                            ...
                            if (!answered) {
                                ...
                                if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked() || rb4.isChecked()) {
                                    ...
                                    Toast.makeText(SingleQuizBiologieActivity.this, "Please select an answer", Toast.LENGTH_SHORT).show();
                                }
                            } else {
...

        {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if (networkInfo == null) {
                    Toast.makeText(SingleQuizBiologieActivity.this, "Check Your Internet Connection", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(SingleQuizBiologieActivity.this, "Server Error", Toast.LENGTH_SHORT).show();
                }
            }
        }
        );
        RequestQueue queue = Volley.newRequestQueue(SingleQuizBiologieActivity.this);
        queue.add(request);
    ...
    private void finishQuiz() {
        ...
        //Wrong ANswers
        int wrong = questionCountTotal - Bilogiescore;
        //Correct Answerr
        int p = 100 / questionCountTotal;
        int BilogiePoints = p * Bilogiescore;


        //store values in shared prefences
        //points and worngs answers for later use
        preferences = this.getSharedPreferences("quiz_points", MODE_PRIVATE);
        editor = preferences.edit();
        editor.putInt("biologiePoints", BilogiePoints);
        editor.putInt("biologieWrong", wrong);
        editor.apply();
        ...
        AlertDialog.Builder dialog = new AlertDialog.Builder(SingleQuizBiologieActivity.this);
        dialog.setCancelable(false);
        dialog.setTitle("Result");
        dialog.setMessage("Correct=" + Bilogiescore + " Wrong=" + wrong + "\n Points=" + BilogiePoints);
