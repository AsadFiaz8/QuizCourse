...
public class GeographyQuizFormActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    String url = "https://tanaseandrei0513.000webhostapp.com/insertGeography.php";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_geography_quiz_form);

        getSupportActionBar().setTitle("Geografie");
    ...
    private void addQUestionInDatabase() {
        ...
        RequestQueue queue = Volley.newRequestQueue(GeographyQuizFormActivity.this);
        ...
        StringRequest request = new StringRequest(
            ...
            public void onResponse(String response) {
                ...
                Toast.makeText(GeographyQuizFormActivity.this, response, Toast.LENGTH_SHORT).show();
                txtQuestion.setText("");
                txtOption1.setText("");
                txtOption2.setText("");
                txtOption3.setText("");
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(GeographyQuizFormActivity.this, error.toString(), Toast.LENGTH_SHORT).show();
                ConnectivityManager manager = (ConnectivityManager) getSystemService(CONNECTIVITY_SERVICE);
                NetworkInfo networkInfo = manager.getActiveNetworkInfo();
                if (networkInfo == null) {
                    Toast.makeText(GeographyQuizFormActivity.this, "Check Your Internet Connection", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(GeographyQuizFormActivity.this, "Server Error", Toast.LENGTH_SHORT).show();
                }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.show_question:
                Intent intent1 = new Intent(GeographyQuizFormActivity.this, ShowQuestionsActivity.class);
                startActivity(intent1);
                return true;
            case R.id.logout:
                Intent intent = new Intent(GeographyQuizFormActivity.this, Login.class);
    ...
    private void clearNewQuizEntryFields() {
        Intent intent = new Intent(GeographyQuizFormActivity.this, SignUp.class);
        startActivity(intent);
        finish();
    }
}
