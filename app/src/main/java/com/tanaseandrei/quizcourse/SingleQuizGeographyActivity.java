...
public class SingleQuizGeographyActivity extends AppCompatActivity {
    ...
    public static boolean checkGeographyPoints;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_single_quiz_geography);
...
//        textViewCountDown = (TextView) findViewById(R.id.txtCountDown);
    ...
    private void loadServerQuestions() {
        ...
        JsonArrayRequest request = new JsonArrayRequest(
            ...
            public void onResponse(JSONArray response) {
                ...
                if (questionList.isEmpty()) {
                    Toast.makeText(SingleQuizGeographyActivity.this, "Empty Array", Toast.LENGTH_SHORT).show();
                } else {
                        ...
                        public void onClick(View v) {
                            ...
                            if (!answered) {
                                ...
                                if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked() || rb4.isChecked()) {
                                    ...
                                    Toast.makeText(SingleQuizGeographyActivity.this, "Please select an answer", Toast.LENGTH_SHORT).show();
                                }
                            } else {
...

        {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if (networkInfo == null) {
                    Toast.makeText(SingleQuizGeographyActivity.this, "Check Your Internet Connection", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(SingleQuizGeographyActivity.this, "Server Error", Toast.LENGTH_SHORT).show();
                }
            }
        }
        );
        RequestQueue queue = Volley.newRequestQueue(SingleQuizGeographyActivity.this);
        queue.add(request);
    ...
    private void finishQuiz() {
        ...
        //Wrong ANswers
        int wrong = questionCountTotal - Geographyscore;
        //Correct Answerr
        int p = 100 / questionCountTotal;
        int geographyPoints = p * Geographyscore;


        preferences = this.getSharedPreferences("quiz_points", MODE_PRIVATE);
        editor = preferences.edit();
        editor.putInt("geographyPoints", geographyPoints);
        editor.putInt("geographyWrong", wrong);
        editor.apply();
        ...
        AlertDialog.Builder dialog = new AlertDialog.Builder(SingleQuizGeographyActivity.this);
        dialog.setCancelable(false);
        dialog.setTitle("Result");
        dialog.setMessage("Correct=" + Geographyscore + " Wrong=" + wrong + "\nPoints" + geographyPoints);
