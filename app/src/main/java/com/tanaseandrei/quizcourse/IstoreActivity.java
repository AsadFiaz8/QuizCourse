...
public class IstoreActivity extends AppCompatActivity {
    ...
    //wrong answers
    public static int istoreWrongAns;


    //Score
    public static int Istoriascore;
    //got points
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_istore);
    ...
    private void loadServerQuestions() {
        ...
        JsonArrayRequest request = new JsonArrayRequest(
            ...
            public void onResponse(JSONArray response) {
                ...
                if (questionList.isEmpty()) {
                    Toast.makeText(IstoreActivity.this, "Empty Array", Toast.LENGTH_SHORT).show();
                } else {
                        ...
                        public void onClick(View v) {
                            ...
                            if (!answered) {
                                ...
                                if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked() || rb4.isChecked()) {
                                    ...
                                    Toast.makeText(IstoreActivity.this, "Please select an answer", Toast.LENGTH_SHORT).show();
                                }
                            } else {
...

        {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if (networkInfo == null) {
                    Toast.makeText(IstoreActivity.this, "Check Your Internet Connection", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(IstoreActivity.this, "Server Error", Toast.LENGTH_SHORT).show();
                }
            }
        }
        );
        RequestQueue queue = Volley.newRequestQueue(IstoreActivity.this);
        queue.add(request);
    ...
    private void finishQuiz() {
        ...
        AlertDialog.Builder dialog = new AlertDialog.Builder(IstoreActivity.this);
        dialog.setCancelable(false);

        //getting points of IstorialQuiz
        int p = 100 / questionCountTotal;
        istoriaPoints = Istoriascore * p;


        //Wrong and Correct
        istoreWrongAns = questionCountTotal - Istoriascore;
        dialog.setTitle("Correct=" + Istoriascore + " Wrong=" + istoreWrongAns + "\nPoints =" + istoriaPoints);


        dialog.setMessage("Start Romana Quiz ");
        dialog.setPositiveButton("Start", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int id) {

                Intent intent = new Intent(IstoreActivity.this, RomanaActivity.class);
                intent.putExtra("score", Istoriascore);
    ...
    public void onBackPressed() {
        ...
        dialog.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int id) {
                ...
                Intent intent = new Intent(IstoreActivity.this, Login.class);
                startActivity(intent);
                finish();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.show_grades:
                Intent intent1 = new Intent(IstoreActivity.this, UserPointsActivity.class);
