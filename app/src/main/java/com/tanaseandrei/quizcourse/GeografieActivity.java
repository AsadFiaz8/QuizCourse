...
public class GeografieActivity extends AppCompatActivity {


    String url = "https://tanaseandrei0513.000webhostapp.com/encodeGeoGraphy.php";
    ...
    //wrong answers
    public static int geographieWrongAns;

    //Score
    public static int scoreGeoGraphy;
    //got points
    public static int GeografiePoints;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Geografie Quiz");
    ...
    private void loadServerQuestions() {
        ...
        JsonArrayRequest request = new JsonArrayRequest(
            ...
            public void onResponse(JSONArray response) {
                ...
                if (questionList.isEmpty()) {
                    Toast.makeText(GeografieActivity.this, "Empty Array", Toast.LENGTH_SHORT).show();
                } else {
                        ...
                        public void onClick(View v) {
                            ...
                            if (!answered) {
                                ...
                                if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked() || rb4.isChecked()) {
                                    ...
                                    Toast.makeText(GeografieActivity.this, "Please select an answer", Toast.LENGTH_SHORT).show();
                                }
                            } else {
...

        {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if (networkInfo == null) {
                    Toast.makeText(GeografieActivity.this, "Check Your Internet Connection", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(GeografieActivity.this, "Server Error", Toast.LENGTH_SHORT).show();
                }
            }
        }
        );
        RequestQueue queue = Volley.newRequestQueue(GeografieActivity.this);
        queue.add(request);
    ...
    private void finishQuiz() {
        ...
        AlertDialog.Builder dialog = new AlertDialog.Builder(GeografieActivity.this);
        dialog.setCancelable(false);

        //getting points of IstorialQuiz
        int p2 = 100 / questionCountTotal;
        GeografiePoints = scoreGeoGraphy * p2;

        geographieWrongAns = questionCountTotal - scoreGeoGraphy;
        dialog.setTitle("Correct=" + scoreGeoGraphy + " Wrong=" + geographieWrongAns + "\nPoints =" + GeografiePoints);


        dialog.setMessage("Start Psihologie Quiz?");
        dialog.setPositiveButton("Start", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int id) {

                Intent intent = new Intent(GeografieActivity.this, PsihologieActivity.class);
                intent.putExtra("score", scoreGeoGraphy);
    ...
    public void onBackPressed() {
        ...
        dialog.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int id) {
                ...
                Intent intent = new Intent(GeografieActivity.this, Login.class);
                startActivity(intent);
                finish();
