...
public class OptionalSocilogieQuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_optional_socilogie_quiz);
...
//        textViewCountDown = (TextView) findViewById(R.id.txtCountDown);
    ...
    private void loadServerQuestions() {
        ...
        JsonArrayRequest request = new JsonArrayRequest(
            ...
            public void onResponse(JSONArray response) {
                ...
                if (questionList.isEmpty()) {
                    Toast.makeText(OptionalSocilogieQuizActivity.this, "Empty Array", Toast.LENGTH_SHORT).show();
                } else {
                        ...
                        public void onClick(View v) {
                            ...
                            if (!answered) {
                                ...
                                if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked() || rb4.isChecked()) {
                                    ...
                                    Toast.makeText(OptionalSocilogieQuizActivity.this, "Please select an answer", Toast.LENGTH_SHORT).show();
                                }
                            } else {
...

        {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if (networkInfo == null) {
                    Toast.makeText(OptionalSocilogieQuizActivity.this, "Check Your Internet Connection", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(OptionalSocilogieQuizActivity.this, "Server Error", Toast.LENGTH_SHORT).show();
                }
            }
        }
        );
        RequestQueue queue = Volley.newRequestQueue(OptionalSocilogieQuizActivity.this);
        queue.add(request);
    ...
    private void finishQuiz() {
        ...
        AlertDialog.Builder dialog = new AlertDialog.Builder(OptionalSocilogieQuizActivity.this);
        ...
        //All Quizes Final Correct Ansers
        final int finalScore = Istoriascore + romanaScore + scoreGeoGraphy + scorePshilogy + Biologyscore + scoreSocilogie;

        int AllQUizesPoints = istoriaPoints + RomanaPoints + GeografiePoints + PshilogyPoints + BiologiePoints + pointsocilogie;
        ...
        dialog.setPositiveButton("Generate Result", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int id) {
                ...
                AlertDialog.Builder innserDialog = new AlertDialog.Builder(OptionalSocilogieQuizActivity.this);
                innserDialog.setCancelable(false);
                innserDialog.setTitle("Final Result");

                //Whole Wrong Anwers
                int wholeWrongAnsers = IstoreActivity.istoreWrongAns +
                        RomanaActivity.RomanaWrongAns +
                        PsihologieActivity.PsichlogieWrongAns +
                        GeografieActivity.geographieWrongAns +
                        BiologieActivity.BiologieWrongAns +
                        OptionalSocilogieQuizActivity.wrongSocilogieAns;
                ;
                ...
                innserDialog.setPositiveButton("Finish", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(final DialogInterface dialog, int id) {
                        ...
                        final ProgressDialog progressDialog = new ProgressDialog(OptionalSocilogieQuizActivity.this);
                        progressDialog.show();
                        ...
                        StringRequest request = new StringRequest(
                            ...
                            public void onResponse(String response) {
                                ...
                                if (response.equalsIgnoreCase("SuccessFully Inserted")) {
                                    ...
                                    Toast.makeText(OptionalSocilogieQuizActivity.this, "Points are saved", Toast.LENGTH_SHORT).show();
                                    Intent intent = new Intent(OptionalSocilogieQuizActivity.this, UserPointsActivity.class);
                            ...
                            public void onErrorResponse(VolleyError error) {
                                ...
                                dialog.dismiss();
                                Toast.makeText(OptionalSocilogieQuizActivity.this, error.toString(), Toast.LENGTH_SHORT).show();
    ...
    public void onBackPressed() {
        ...
        dialog.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int id) {
                ...
                Intent intent = new Intent(OptionalSocilogieQuizActivity.this, Login.class);
                startActivity(intent);
                finish();
