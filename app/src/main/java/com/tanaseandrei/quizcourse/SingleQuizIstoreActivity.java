...
public class SingleQuizIstoreActivity extends AppCompatActivity {

    String url = "https://tanaseandrei0513.000webhostapp.com/encodeHistory.php";
    ...
    //Score
    public static int IstoriaSingleScoreActivity;
    //got points
    public static int istoriaPoints;
    //Points for Quiz Every Subject
    public static int QuizPoints = 100;
    ...
    public static boolean checkIstorePoints;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_single_quiz_istore);

        getSupportActionBar().setTitle("Istore Quiz");
...
//        textViewCountDown = (TextView) findViewById(R.id.txtCountDown);
    ...
    private void loadServerQuestions() {
        ...
        JsonArrayRequest request = new JsonArrayRequest(
            ...
            public void onResponse(JSONArray response) {
                ...
                if (questionList.isEmpty()) {
                    Toast.makeText(SingleQuizIstoreActivity.this, "Empty Array", Toast.LENGTH_SHORT).show();
                } else {
                        ...
                        public void onClick(View v) {
                            ...
                            if (!answered) {
                                ...
                                if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked() || rb4.isChecked()) {
                                    ...
                                    Toast.makeText(SingleQuizIstoreActivity.this, "Please select an answer", Toast.LENGTH_SHORT).show();
                                }
                            } else {
...

        {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if (networkInfo == null) {
                    Toast.makeText(SingleQuizIstoreActivity.this, "Check Your Internet Connection", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(SingleQuizIstoreActivity.this, "Server Error", Toast.LENGTH_SHORT).show();
                }
            }
        }
        );
        RequestQueue queue = Volley.newRequestQueue(SingleQuizIstoreActivity.this);
        queue.add(request);
    ...
    private void finishQuiz() {
        ...
        //Wrong ANswers
        int wrong = questionCountTotal - IstoriaSingleScoreActivity;
        //istoria quiz points
        int p = 100 / questionCountTotal;
        int istoriePoints = p * IstoriaSingleScoreActivity;


        //prefences code to hole value
        preferences = this.getSharedPreferences("quiz_points", MODE_PRIVATE);
        editor = preferences.edit();
        editor.putInt("istoriaPoints", istoriePoints);
        editor.putInt("istoriaWrong", wrong);
        editor.apply();
        ...
        //alert dialog
        AlertDialog.Builder dialog = new AlertDialog.Builder(SingleQuizIstoreActivity.this);
        dialog.setCancelable(false);
        dialog.setTitle("Result");

        dialog.setMessage("Correct=" + IstoriaSingleScoreActivity + " Wrong=" + wrong + "\nPoints=" + istoriePoints);
        dialog.setPositiveButton("Close Quiz", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int id) {

                checkIstorePoints = true;
                finish();
                //Action for "Delete".
            }
        });
