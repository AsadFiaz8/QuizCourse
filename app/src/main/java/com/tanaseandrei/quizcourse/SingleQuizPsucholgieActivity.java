...
public class SingleQuizPsucholgieActivity extends AppCompatActivity {
    ...
    //Score
    public static int Psycholgiescore;
    ...
    public static boolean checkPsychologyPoints;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_single_quiz_psucholgie);

        getSupportActionBar().setTitle("Psycholgie");
...
//        textViewCountDown = (TextView) findViewById(R.id.txtCountDown);
    ...
    private void loadServerQuestions() {
        ...
        JsonArrayRequest request = new JsonArrayRequest(
            ...
            public void onResponse(JSONArray response) {
                ...
                if (questionList.isEmpty()) {
                    Toast.makeText(SingleQuizPsucholgieActivity.this, "Empty Array", Toast.LENGTH_SHORT).show();
                } else {
                        ...
                        public void onClick(View v) {
                            ...
                            if (!answered) {
                                ...
                                if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked() || rb4.isChecked()) {
                                    ...
                                    Toast.makeText(SingleQuizPsucholgieActivity.this, "Please select an answer", Toast.LENGTH_SHORT).show();
                                }
                            } else {
...

        {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if (networkInfo == null) {
                    Toast.makeText(SingleQuizPsucholgieActivity.this, "Check Your Internet Connection", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(SingleQuizPsucholgieActivity.this, "Server Error", Toast.LENGTH_SHORT).show();
                }
            }
        }
        );
        RequestQueue queue = Volley.newRequestQueue(SingleQuizPsucholgieActivity.this);
        queue.add(request);
    ...
    private void finishQuiz() {
        ...
        //Wrong ANswers
        int wrong = questionCountTotal - Psycholgiescore;
        //Correct Answerr
        int p = 100 / questionCountTotal;
        int PsycholgiePoints = p * Psycholgiescore;


        preferences = this.getSharedPreferences("quiz_points", MODE_PRIVATE);
        editor = preferences.edit();
        editor.putInt("pscychoPoints", PsycholgiePoints);
        editor.putInt("psychoWrong", wrong);
        editor.apply();
        ...
        AlertDialog.Builder dialog = new AlertDialog.Builder(SingleQuizPsucholgieActivity.this);
        dialog.setCancelable(false);
        dialog.setTitle("Result");

        dialog.setMessage("Correct=" + Psycholgiescore + " Wrong=" + wrong + "\n Points=" + PsycholgiePoints);
