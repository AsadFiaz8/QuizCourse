...
public class IstorieQuizFormActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {

    //isotore=History

    //varible to close aplication
    private long backPressedTime;
    //spinner item to select correct value
    Spinner spinnerCorrectOption;
    //cast string  correct return spinner value to int
    String correctOption;
    //Button to add question in sqlite database
    Button addQUestion;
    //Editetext fields for question
    EditText txtQuestion, txtOption1, txtOption2, txtOption3, txtOption4;

    String url = "https://tanaseandrei0513.000webhostapp.com/insertHistory.php";


    //DB Class Reference which contain intorie Quiz questions
    //IstorieDBHelper dbhelper;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_istorie_quiz_form);

        //changing the title of action bar
        getSupportActionBar().setTitle("Istorie");

        //cast variables to id
        ...
        //initialze Db class
        //  dbhelper = new IstorieDBHelper(this);

        //click listener on add question to database
        ...
        //Spinner arrayapdter and click listener on it to get sleect value
    ...
    private void addQUestionInDatabase() {
        ...
        RequestQueue queue = Volley.newRequestQueue(IstorieQuizFormActivity.this);
        ...
        StringRequest request = new StringRequest(
            ...
            public void onResponse(String response) {
                ...
                Toast.makeText(IstorieQuizFormActivity.this, response, Toast.LENGTH_SHORT).show();
                txtQuestion.setText("");
                txtOption1.setText("");
                txtOption2.setText("");
                txtOption3.setText("");
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(IstorieQuizFormActivity.this, error.toString(), Toast.LENGTH_SHORT).show();
                ConnectivityManager manager = (ConnectivityManager) getSystemService(CONNECTIVITY_SERVICE);
                NetworkInfo networkInfo = manager.getActiveNetworkInfo();
                if (networkInfo == null) {
                    Toast.makeText(IstorieQuizFormActivity.this, "Check Your Internet Connection", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(IstorieQuizFormActivity.this, "Server Error", Toast.LENGTH_SHORT).show();
                }
    ...
    //override methids of spinner callbacks
    @Override
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        correctOption = String.valueOf(parent.getItemAtPosition(position));
        //Toast.makeText(this, correctOption, Toast.LENGTH_SHORT).show();
    }
    ...
    //no need to explain it already explian in signup and login
    @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.show_question:
                Intent intent1 = new Intent(IstorieQuizFormActivity.this, ShowQuestionsActivity.class);
                startActivity(intent1);
                return true;
            case R.id.logout:
                Intent intent = new Intent(IstorieQuizFormActivity.this, Login.class);
    ...
    private void clearNewQuizEntryFields() {
        Intent intent = new Intent(IstorieQuizFormActivity.this, SignUp.class);
        startActivity(intent);
        finish();
    }
}
