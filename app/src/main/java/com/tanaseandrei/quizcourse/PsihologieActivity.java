...
public class PsihologieActivity extends AppCompatActivity {


    String url = "https://tanaseandrei0513.000webhostapp.com/encodePsychology.php";
    ...
    //wrong answers
    public static int PsichlogieWrongAns;

    //Score
    public static int scorePshilogy;
    //got points
    public static int PshilogyPoints;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_psihologie);


        getSupportActionBar().setTitle("Psihologie Quiz");
...
//        textViewCountDown = (TextView) findViewById(R.id.txtCountDown);
    ...
    private void loadServerQuestions() {
        ...
        JsonArrayRequest request = new JsonArrayRequest(
            ...
            public void onResponse(JSONArray response) {
                ...
                if (questionList.isEmpty()) {
                    Toast.makeText(PsihologieActivity.this, "Empty Array", Toast.LENGTH_SHORT).show();
                } else {
                        ...
                        public void onClick(View v) {
                            ...
                            if (!answered) {
                                ...
                                if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked() || rb4.isChecked()) {
                                    ...
                                    Toast.makeText(PsihologieActivity.this, "Please select an answer", Toast.LENGTH_SHORT).show();
                                }
                            } else {
...

        {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if (networkInfo == null) {
                    Toast.makeText(PsihologieActivity.this, "Check Your Internet Connection", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(PsihologieActivity.this, "Server Error", Toast.LENGTH_SHORT).show();
                }
            }
        }
        );
        RequestQueue queue = Volley.newRequestQueue(PsihologieActivity.this);
        queue.add(request);
    ...
    private void finishQuiz() {
        ...
        AlertDialog.Builder dialog = new AlertDialog.Builder(PsihologieActivity.this);
        dialog.setCancelable(false);

        //getting points of IstorialQuiz
        int pq = QuizPoints / questionCountTotal;
        PshilogyPoints = scorePshilogy * pq;

        PsichlogieWrongAns = questionCountTotal - scorePshilogy;
        dialog.setTitle("Correct=" + scorePshilogy + " Wrong=" + PsichlogieWrongAns + "\nPoints =" + PshilogyPoints);


        dialog.setMessage("Start Biologie Quiz?");
        dialog.setPositiveButton("Start", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int id) {

                Intent intent = new Intent(PsihologieActivity.this, BiologieActivity.class);
                intent.putExtra("score", scorePshilogy);
    ...
    public void onBackPressed() {
        ...
        dialog.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int id) {
                ...
                Intent intent = new Intent(PsihologieActivity.this, Login.class);
                startActivity(intent);
                finish();
