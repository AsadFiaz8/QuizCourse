...
public class RomanaQuizFormAcitivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    String url = "https://tanaseandrei0513.000webhostapp.com/insertRomana.php";

    //RomanaDBHelper dbhelper;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_romana_quiz_form_acitivity);
        ...
        //dbhelper = new RomanaDBHelper(this);
    ...
    private void addQUestionInDatabase() {
        ...
        RequestQueue queue = Volley.newRequestQueue(RomanaQuizFormAcitivity.this);
        ...
        StringRequest request = new StringRequest(
            ...
            public void onResponse(String response) {
                ...
                Toast.makeText(RomanaQuizFormAcitivity.this, response, Toast.LENGTH_SHORT).show();
                txtQuestion.setText("");
                txtOption1.setText("");
                txtOption2.setText("");
                txtOption3.setText("");
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(RomanaQuizFormAcitivity.this, error.toString(), Toast.LENGTH_SHORT).show();
                ConnectivityManager manager = (ConnectivityManager) getSystemService(CONNECTIVITY_SERVICE);
                NetworkInfo networkInfo = manager.getActiveNetworkInfo();
                if (networkInfo == null) {
                    Toast.makeText(RomanaQuizFormAcitivity.this, "Check Your Internet Connection", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(RomanaQuizFormAcitivity.this, "Server Error", Toast.LENGTH_SHORT).show();
                }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.show_question:
                Intent intent1 = new Intent(RomanaQuizFormAcitivity.this, ShowQuestionsActivity.class);
                startActivity(intent1);
                return true;
            case R.id.logout:
                Intent intent = new Intent(RomanaQuizFormAcitivity.this, Login.class);
    ...
    private void clearNewQuizEntryFields() {
        Intent intent = new Intent(RomanaQuizFormAcitivity.this, SignUp.class);
        startActivity(intent);
        finish();
    }
}
